...
class PublishSolution
{
    ...
    static String broker_host = "localhost"; // host where broker is running
    static String broker_name = "Broker #1"; // name of the broker
    static String client_group = "sample"; // name of the client group
    static String event_type_name = "Sample::SimpleEvent"; // name of the event
	...
	try {
	    ...
	    e = new BrokerEvent(c, event_type_name);
	...
	try {
	    ...
	    can_publish = c.canPublish(event_type_name);
