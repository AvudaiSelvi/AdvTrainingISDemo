package advTrainingISDemo.solution.exactlyOnce;
...

{
        ...
        throws ServiceException
	{
		...
		// @subtype unknown
		// @sigtype java 3.5
		// [i] recref:0:required Trans advTrainingISDemo.solution.exactlyOnce.docs:Trans
		// pipeline
        ...
        throws ServiceException
	{
		...
		// @subtype unknown
		// @sigtype java 3.5
		// [o] recref:1:required Transactions advTrainingISDemo.solution.exactlyOnce.docs:Trans
		// pipeline
		IDataCursor pipelineCursor = pipeline.getCursor();
		synchronized(AllTransactions) {
		  IDataCursor AllTransactionsCursor = AllTransactions.getCursor();
        ...
        throws ServiceException
	{
		...
		// [o] recref:0:required Trans advTrainingISDemo.solution.exactlyOnce.docs:Trans
